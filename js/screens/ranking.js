...
const COLUMNAS = [
  ...
  { key: 'porcentajeStockBarcelona', label: '% stock Barcelona' },
  { key: 'nRoturasStock', label: 'Nº roturas de stock' },
  { key: 'nRoturasStockBarcelona', label: 'Nº roturas de stock Barcelona' },
  { key: 'vendidoEstimado', label: 'Vendido estimado' },
  { key: 'vendidoEstimadoBarcelona', label: 'Vendido estimado Barcelona' },
  { key: 'diasHastaRotura', label: 'Días estimados hasta rotura' },
  { key: 'repuestoEstimado', label: 'Repuesto estimado' },
  { key: 'repuestoEstimadoBarcelona', label: 'Repuesto estimado Barcelona' },
  { key: 'ratioRepuestoVendido', label: 'Ratio repuesto/vendido' },
