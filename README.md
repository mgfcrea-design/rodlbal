...
Aplicación interna para monitorizar el stock público   y estimar rotación de códigos mediante cierres periódicos pegados manualmente.

## Uso
1. Entrar con las credenciales del único usuario autorizado (Supabase Auth).
2. Pegar bloques de texto de páginas de en "Cargar cierre".
